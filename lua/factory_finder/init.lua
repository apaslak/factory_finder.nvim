...
function M.setup(user_config)
  ...
  shared_context_finder.load_cache(M.config)
end
...
vim.api.nvim_create_user_command("SharedContextGoToDefinition", function() shared_context_finder.go_to_definition(M.config) end, { nargs = 0, desc = "Find shared_context definition" })
vim.api.nvim_create_user_command("RefreshSharedContextCache", function() shared_context_finder.refresh_cache(M.config) end, { nargs = 0, desc = "Refresh shared_context cache" })
vim.api.nvim_create_user_command("InspectSharedContextCache", function() shared_context_finder.inspect_cache(M.config) end, { nargs = 0, desc = "Inspect shared_context cache" })
